...
<body>
    ...
    <div id="ensemble" class="catalogue">
      <?php
        $produits = $bdd->query('SELECT * FROM produits INNER JOIN types ON produits.Id_Type_Produit = types.Id_Type INNER JOIN membres ON produits.Id_Membre_Produit = membres.Id_Membre WHERE Libelle_Type = "Tour Fixe"');
