...
<body>
    ...
    <div id="ensemble">
      <?php
        ...
        $produits = $bdd->query('SELECT * FROM produits INNER JOIN images ON produits.Id_Image = images.Id_Image INNER JOIN types ON produits.Id_Type = types.Id_Type INNER JOIN membres ON produits.Id_Membre = membres.Id_Membre');
